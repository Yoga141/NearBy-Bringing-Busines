  ...
  <AuthLayout brand-gradient="linear-gradient(165deg, #3e8e82, #16324b)" footer-color="#A9C7C1">
    ...
    <template #brand-middle>
      ...
      <div class="mt-[26px] flex flex-col gap-3.5">
        <div class="flex items-center gap-[11px] text-[#E7F0EE]">
    ...
    <template #form>
      <div class="w-full max-w-[410px]">
        ...
        <input v-model="regName" placeholder="Nama kamu" class="mb-[13px] w-full rounded-xl border border-border-input bg-white px-[15px] py-3" />
        <label class="mb-1.5 block text-[13.5px] font-bold">Email</label>
        <input v-model="regEmail" placeholder="nama@email.com" class="mb-[13px] w-full rounded-xl border border-border-input bg-white px-[15px] py-3" />
        <label class="mb-1.5 block text-[13.5px] font-bold">Password</label>
        <input
          v-model="regPass"
          type="password"
          placeholder="Minimal 8 karakter"
          class="mb-[18px] w-full rounded-xl border border-border-input bg-white px-[15px] py-3"
        />
        <button
          type="button"
        ...
        <p class="mt-5 text-center font-semibold text-text-muted">
          Sudah punya akun?
