...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Jul 2026 pada 02.30
...
(1, NULL, NULL, 'Bakso Urat Cak War', 'Suwarno', 'Kuliner', 'Balikpapan Selatan', 'menunggu', '[[\"Deskripsi usaha\",true],[\"Alamat lengkap\",true],[\"Nomor telepon\",true],[\"Foto (min. 3)\",false],[\"Jam operasional\",true],[\"Kategori & wilayah\",true]]', '[{\"name\":\"Tampak depan\",\"kind\":\"image\",\"ok\":true,\"meta\":\"JPG \\u00b7 1.2 MB\"},{\"name\":\"Menu bakso\",\"kind\":\"image\",\"ok\":true,\"meta\":\"JPG \\u00b7 980 KB\"},{\"name\":\"Foto tempat 3\",\"kind\":\"image\",\"ok\":false,\"meta\":\"Belum diunggah\"},{\"name\":\"KTP pemilik\",\"kind\":\"doc\",\"ok\":true,\"meta\":\"PDF \\u00b7 640 KB\"},{\"name\":\"Surat izin usaha (SIUP)\",\"kind\":\"doc\",\"ok\":false,\"meta\":\"Belum diunggah\"}]', '2026-07-21 18:16:09', '2026-07-21 18:16:09'),
...
(9, NULL, 'Wisma Somber Stay', 'Penginapan', 'Balikpapan Utara', 4.4, 41, 'Rp150–280rb', 'Penginapan bersih dekat pelabuhan Somber, praktis untuk transit.', 'foto wisma', 'Jl. Sultan Hasanuddin No. 17, Balikpapan Utara', 'Check-in 13.00 · Check-out 12.00', '0822-3344-5566', '@somber.stay', 'Tipe kamar', 'aktif', 'disetujui', 0, NULL, '2026-07-21 18:16:09', '2026-07-21 18:16:09'),
...
(7, 'winata', 'winn@gmail.com', NULL, NULL, '$2y$12$gSlv/9gbaq1hd4JFoXEIuOHjwkQJxsYKq3dX.HopZQaKoS0ei/8nK', 'user', 'aktif', NULL, '2026-07-21 18:23:17', '2026-07-21 18:23:17', NULL);
