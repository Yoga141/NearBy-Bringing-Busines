  ...
  <section class="mx-auto max-w-[1200px] px-6 pt-[70px] pb-5">
    <div class="mb-[26px] flex items-end justify-between gap-5">
      <div>
        ...
        <h2 class="mt-1.5 text-[32px] font-extrabold tracking-[-.02em]">Mau cari apa hari ini?</h2>
      </div>
    ...
    <div class="grid grid-cols-2 gap-4 mobile:grid-cols-3 tablet:grid-cols-5">
      ...
      >
        <div
          class="flex h-[54px] w-[54px] items-center justify-center rounded-[15px] text-[22px] font-extrabold"
