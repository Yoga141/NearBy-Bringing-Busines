...
<template>
  <div class="fixed right-[22px] bottom-[22px] z-[75] flex flex-col items-end gap-3">
    <div
      v-if="ui.helpOpen"
    ...
    <button
      ...
      title="Bantuan & FAQ"
      aria-label="Bantuan"
      class="flex h-[58px] w-[58px] items-center justify-center rounded-full bg-brand-navy text-2xl font-extrabold text-white shadow-[0_12px_30px_rgba(19,50,77,.35)] transition-all hover:-translate-y-0.5 hover:bg-brand-blue-deep"
      @click="ui.toggleHelp"
    >
      ?
    </button>
