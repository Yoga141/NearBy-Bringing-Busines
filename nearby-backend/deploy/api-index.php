 ...
 *
 * Kenapa file ini ada:
 * .cpanel.yml menyalin isi `nearby-backend/public/` ke `public_html/api/`,
 ...
 * `cp -R nearby-backend/* ...` di .cpanel.yml kalau suatu saat dipindah.
 */
...
// `nearby-backend/public`, jadi `public_path()` diarahkan ke sini.
